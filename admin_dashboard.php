 ...
 * 
 * OOP Kullanımı:
 * - AdminController: Admin işlemlerini yönetir (extends BaseController)
 * - BusCompanyService: Firma CRUD işlemleri
 * - CouponService: Kupon CRUD işlemleri
 * - AuthService: Firma admin oluşturma
 * - UserRepository: Kullanıcı verileri (Repository Pattern)
 * - Facade Pattern: Controller, birden fazla service'i koordine eder
 */
