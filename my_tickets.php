 ...
 * 
 * OOP Kullanımı:
 * - TicketService: Bilet listesini getirir (Service Layer)
 * - TicketRepository: Veritabanı erişimi (Repository Pattern)
...
$tickets = $ticketService->getUserTickets($_SESSION['user_id']);
